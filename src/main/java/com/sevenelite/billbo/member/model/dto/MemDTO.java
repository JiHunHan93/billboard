...
public class MemDTO implements java.io.Serializable {
	...
	public MemDTO(int no, String name, String id, String pwd, String pno, String gender, String email, String address,
	...
	public String toString() {
		return "MemDTO [no=" + no + ", name=" + name + ", id=" + id + ", pwd=" + pwd + ", pno=" + pno + ", gender="
