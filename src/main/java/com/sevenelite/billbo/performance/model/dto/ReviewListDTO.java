...
public class ReviewListDTO {
	...
	private double reviewAvg; //인사평가 평균
	...
	public String toString() {
		return "ReviewListDTO [reviewNo=" + reviewNo + ", memberNo=" + memberNo + ", achOne=" + achOne + ", achTwo="
				+ achTwo + ", achThree=" + achThree + ", abilOne=" + abilOne + ", abilTwo=" + abilTwo + ", abilThree="
				+ abilThree + ", abilFour=" + abilFour + ", attOne=" + attOne + ", attTwo=" + attTwo + ", attThree="
				+ attThree + ", reviewAvg=" + reviewAvg + ", date=" + date + ", reviewGrade=" + reviewGrade + "]";
	}

	public ReviewListDTO(int reviewNo, int memberNo, int achOne, int achTwo, int achThree, int abilOne, int abilTwo,
			int abilThree, int abilFour, int attOne, int attTwo, int attThree, double reviewAvg, Date date,
			String reviewGrade) {
		super();
		this.reviewNo = reviewNo;
		this.memberNo = memberNo;
