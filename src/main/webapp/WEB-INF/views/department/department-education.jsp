                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Education Department</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">교육부</a></li>
								</ul>
							</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
							   ...
							   <c:forEach var="allDepartmentList" items="${requestScope.allEducationDepartmentList}">
									<tr>
