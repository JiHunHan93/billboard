...
<html lang="ko">
    <head>
		...
		<!-- Chart CSS -->
		<link rel="stylesheet" href="../resources/hrtemp/chart/jquery.orgchart.css">
 		<link rel="stylesheet" href="../resources/hrtemp/chart/style.css">
    ...
    <body>
	    ...
	    <script type="text/javascript" src="../resources/hrtemp/chart/jquery.min.js"></script>
	  <script type="text/javascript" src="../resources/hrtemp/chart/jquery.orgchart.js"></script>
	  <script type="text/javascript">
	    ...
	    var datascource = {
	      ...
	      'children': [
	        ...
	        { 'name': 'PRODUCTION', 'title': 'KIM TAKHEUN' },
	        { 'name': 'EDUCATION', 'title': 'HAN JIHOON',
	          'children': [
	            { 'name': 'EDUCATION', 'title': 'IM WANGGYU' },
	            { 'name': 'EDUCATION', 'title': 'LEE NAMGYEONG'}
	          ]
	        },
	        { 'name': 'EMPLOYEE', 'title': 'CHOI JIHWAN' }
	      ]
	    };
