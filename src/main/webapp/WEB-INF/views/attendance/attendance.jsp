					...
					<div class="row">
								...
								<div class="card-body" style="height: 460px">
									...
									<div class="custom-punch-btn-section">
										<button type="button"
											...
											class="btn btn-primary custom-punch-btn">출근</button>
									</div>
									<div class="custom-punch-btn-section">
										<button type="button" onclick="time" id="finish"
											class="btn btn-primary custom-punch-btn">퇴근</button>
									</div>
						...
						<div class="col-md-4">
							<div class="card att-statistics">
								<div class="card-body" style="height: 460px">
									<h5 class="card-title">총 근무 시간</h5>
									<!--총근무시간제목부분 -->
									<div class="stats-list">
										<div class="stats-info">
											<p>
												오늘 <strong>3.45 <small>/ 8 hrs</small></strong>
											</p>
											<div class="progress">
										...
										<div class="stats-info">
											<p>
												이번주 <strong>28 <small>/ 40 hrs</small></strong>
											</p>
											<div class="progress">
										...
										<div class="stats-info">
											<p>
												이번달 <strong>90 <small>/ 160 hrs</small></strong>
											</p>
											<div class="progress">
										...
										<div class="stats-info">
											<p>
												남은시간 <strong>90 <small>/ 160 hrs</small></strong>
											</p>
											<div class="progress">
