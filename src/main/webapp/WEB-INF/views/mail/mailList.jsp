            ...
            <div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
					<div class="sidebar-menu">
						<ul>
							<li> 
								<a href="index.html"><i class="la la-home"></i> <span>뒤로가기</span></a>
							</li>
							<li class="active"> 
								<a href="inbox.html">문서 <span class="mail-count"></span></a>
							</li>
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">문서</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">메일</a></li>
											...
											<div class="col top-action-left">
												<div class="float-left">
													<div class="btn-group dropdown-action">
														<button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown">선택 <i class="fa fa-angle-down "></i></button>
														<div class="dropdown-menu">
											...
											<table class="table table-inbox table-hover">
												...
												<tbody>
													<tr class="unread clickable-row" data-href="mail-view.html">
														...
														<td class="subject">28일까지 프로젝트 마무리 해주세요</td>
