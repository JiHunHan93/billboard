									...
									<div class="dash-info-list">
										<div class="dash-card category-card"> <!-- text-danger class -->
											<div class="dash-card-container category-dash">
												...
												<i class="fas fa-circle category-dot"><a href="performance/main"><div class="category-sub-text">업무평가</div></a></i>
												...
												<i class="fas fa-circle category-dot"><a href="Rnp/main"><div class="category-sub-text">상벌 관리</div></a></i>
