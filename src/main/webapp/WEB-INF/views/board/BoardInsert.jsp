								...
								<div class="card-body">
									<form action="#">
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
                                                <select class="form-control">
													...
													<option>인사 게시판</option>
													<option>사내 공지 게시판</option>
												</select>
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-md-10">
                                                <textarea rows="5" cols="5" class="autosize" id="ta" placeholder="Enter text here"></textarea>
                                        ...
                                        <div style="text-align: center; padding: 30px;">
                                            <a class="btn btn-success write-btn">업로드</a>
                                            <a class="btn btn-secondary write-btn">작성취소</a>
                                        </div>
									</form>
								</div>
							</div>
