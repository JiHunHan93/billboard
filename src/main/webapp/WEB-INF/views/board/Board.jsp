														...
														<table class="datatable table table-stripped mb-0">
															...
															<c:forEach var="noticeList"
																...
																<tr>
																	...
																	<td><c:out value="${ noticeList.no }" />
																	<td><c:out value="${ noticeList.title }" />
																	<td><c:out value="${ noticeList.writer }" />
																	<td><c:out value="${ noticeList.count }" />
																	<td><c:out value="${ noticeList.enrollDate }" />
																	<td><c:out value="${ noticeList.memberNo }" />
																</tr>
															</c:forEach>
														</table>
													</div>
