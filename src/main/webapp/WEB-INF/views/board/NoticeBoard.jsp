          ...
          <div class="content container-fluid">
             ...
             <div class="file-sidebar dashboard-sub-sidebar">
                <div class="file-header justify-content-center">
                   ...
                   <span><button type="button" class="btn btn-write" id="insertWrite" onclick="location.href='${pageContext.servletContext.contextPath}/noticeBoard/insert'">글쓰기</button></span>
	...
	if(document.getElementsByTagName("td")) {
		...
		for(let i = 0; i < $tds.length; i++) {
			...
			$tds[i].onclick = function() {
				...
				console.log(count);
				console.log(no);
				location.href = "${ pageContext.servletContext.contextPath }/noticeBoard/detail?no=" + no; 
