...
<title>직원인사관리 - main</title>

<!-- shortcut logo -->
<link rel="shortcut icon" type="image/x-icon"
	href="./resources/hrtemp/img/Logo.png">
<!-- Bootstrap CSS -->
<link rel="stylesheet"
...
<!-- Select2 CSS -->
<link rel="stylesheet"
	href="/billbo/resources/hrtemp/css/select2.min.css">

<!-- Datetimepicker CSS -->
<link rel="stylesheet"
	href="/billbo/resources/hrtemp/css/bootstrap-datetimepicker.min.css">

<!-- Tagsinput CSS -->
<link rel="stylesheet"
	href="/billbo/resources/hrtemp/css/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css">

<!-- Main CSS -->
<link rel="stylesheet" href="/billbo/resources/hrtemp/css/style.css">
<link rel="stylesheet"
	href="/billbo/resources/hrtemp/css/profile/profile.css">
<link rel="stylesheet"
	href="/billbo/resources/hrtemp/css/profile/profile1.css">
<link rel="stylesheet"
	href="/billbo/resources/hrtemp/css/profile/profile2.css">
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
							...
							<div class="col-md-12">
								<div class="profile-view">
									...
									<div class="profile-img-wrap">
										<div class="card mb-0">
											<c:forEach var="fileAttach"
												items="${ requestScope.fileAttach }">
								 	...
								 	<input type="submit" value="업로드" class="btn btn-custom">  
												...
												<div class="profile-img">
													<a href="#"><img
														src="/billbo/resources/uploadFiles/<c:out value="${fileAttach.savedName}"/>"></a>
												</div>
											</c:forEach>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-5">
											<div class="profile-info-left">
												<c:forEach var="detailMem"
													items="${ requestScope.detailMem }">
													<h3 class="user-name m-t-0 mb-0">${ detailMem.name }님의 인사 정보 페이지.</h3>
													<br>
													<br>
													<div class="staff-id">Employee ID :${ detailMem.email }</div>
												</c:forEach>
												...
												<div class="staff-msg" hidden='true'>
										...
										<ul class="personal-info">
												<li><c:forEach var="detailMem"
														items="${ requestScope.detailMem }">
														<div class="title">
															Phone:
															<c:out value="${detailMem.phone}" />
														</div>
														<!-- <div class="text"></div> -->
													</c:forEach></li>
												<br>
												...
												<c:forEach var="detailMem"
													...
													<li><br> <br>
														<div class="title">
															사번:
															<c:out value="${detailMem.no}" />
														</div> <!-- <div class="text"></div> --></li>
													<br>
													<br>
													<li>
														<div class="title">
															Email:
															<c:out value="${ detailMem.email }" />
														</div> <!-- <div class="text"><a href=""></a></div> -->
													</li>
												</c:forEach>
				...
				<div class="row user-tabs">
					<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
						<ul class="nav nav-tabs nav-tabs-bottom">
							<li class="nav-item"><a href="#emp_profile"
								data-toggle="tab" class="nav-link active">신상</a></li>
							<li class="nav-item"><a href="#emp_job" data-toggle="tab"
								class="nav-link">직위</a></li>
							<li class="nav-item"><a href="#emp_part" data-toggle="tab"
								class="nav-link">부서</a></li>
							<li class="nav-item"><a href="#emp_career" data-toggle="tab"
								class="nav-link">경력</a></li>
							<li class="nav-item"><a href="#emp_bonus" data-toggle="tab"
								class="nav-link">상벌내역</a></li>
							<li class="nav-item"><a href="#emp_qualification"
								data-toggle="tab" class="nav-link">자격</a></li>
							<li class="nav-item"><a href="#armyInfo" data-toggle="tab"
								class="nav-link">병역</a></li>
							<li class="nav-item"><a href="#emp_education"
								data-toggle="tab" class="nav-link">학력</a></li>
							<li class="nav-item"><a href="#emp_family" data-toggle="tab"
								class="nav-link">가족사항</a></li>
							<li class="nav-item"><a href="#emp_license"
								data-toggle="tab" class="nav-link">면허</a></li>
			...
			<div class="tab-content">
				...
				<div id="emp_profile" class="pro-overview tab-pane fade show active">
					<div class="tab-content">
						<div class="ehr_con_wrap">
							<div>
								<h3 class="tab_title">신상정보</h3>
								<div class="ehr_detail viewForm">

									<form
										action="${ pageContext.servletContext.contextPath }/profile/main"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
											...
											<tbody>
												<c:choose>
													...
													<span class="title_txt">신상번호</span>
															...
															<td class="col2"><input class="txt w_max"
																type="text" name="info_no" value=""></td>
															<th class="col3"><span class="title_txt">사번</span></th>
															<td class="col4"><input class="txt w_max"
																type="text" name="member_no" value=""></td>
															<th class="col5"><span class="title_txt">입사일</span>

															</th>
															<td class="col6"><input class="txt w_max"
																type="date" name="enroll_date" value=""></td>
															<th class="col7"><span class="title_txt">계좌은행</span>
															</th>
															<td class="col8"><input class="txt w_max"
																type="text" name="account_bank" value=""></td>
														</tr>
														<tr>
															<th class="col1"><span class="title_txt">주소</span></th>

															<td colspan="5"><input class="txt w_max" type="text"
																name="address" value=""></td>
															<th class="col7"><span class="title_txt">계좌번호</span>
															</th>
															<td class="col8"><input class="txt w_max"
																type="text" name="account_no" value=""></td>
														</tr>
														<tr>
															<!-- <th class="col1">
												...
												<input class="txt w_max" type="text" name="fileattachment" value="">
															...
															<th class="col7"><span class="title_txt">예금주</span>
															</th>
															<td class="col8"><input class="txt w_max"
																type="text" name="account_host" value=""></td>
														</tr>
												...
												<input class="txt w_max" type="text" name="info_no" value="<c:out value="${ member.info_no }"/>">
																...
																<th class="col3"><span class="title_txt">사번</span>
																</th>
														</c:forEach>
														<c:forEach var="detailMem"
															items="${requestScope.detailMem}">
															<td class="col4"><input class="txt w_max"
																type="text" name="member_no" value="${ detailMem.no }">
															</td>
														</c:forEach>
														<c:forEach var="member" items="${requestScope.member}">
															<th class="col5"><span class="title_txt">입사일</span>
															...
															<td class="col6"><input class="txt w_max"
																type="date" name="enroll_date"
																value="<c:out value="${ member.enroll_date }"/>">

															</td>
															</tr>
															<tr>
																<th class="col1"><span class="title_txt">주소</span>
																</th>

																<td colspan="5"><input class="txt w_max"
																	type="text" name="address"
																	value="<c:out value="${ member.address }"/>"></td>
															</tr>
															<tr>
																<%-- <th class="col1">
													<span class="title_txt">근로계약서</span>
												...
												<input class="txt w_max" type="text" name="fileattachment" value="<c:out value="${member.fileattachment }"/>">
																...
																<td class="col8"><input class="txt w_max"
																	type="text" name="account_host"
																	value="<c:out value="${ member.account_host }"/>">
																...
																<td class="col8"><input class="txt w_max"
																	type="text" name="account_bank"
																	value="<c:out value="${ member.account_bank }"/>">
																...
																<td class="col8"><input class="txt w_max"
																	...
																	value="<c:out value="${ member.account_no }"/>">
										...
										<div class="page_action_wrap" style="display: block;">
											...
											<button class="btn_minor" data-role="button"
												id="hrcard_btn_cancel">취소</button>
										</div>
							...
							<section class="aside_wrapper article_reply" id="hrcardActivity">
								<div>
										...
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<tbody id="viewAllInfo">
													<c:forEach var="viewAllInfo"
														items="${requestScope.viewAllInfo }">
														<tr>
															<td id="qq" class="free-td"><c:out
																	value="${ viewAllInfo.member_no }" />
															<td id="qq" class="free-td"><c:out
																	value="${ viewAllInfo.enroll_date }" />
															<td id="qq" class="free-td"><c:out
																	value="${ viewAllInfo.account_no }" />
															<td id="qq" class="free-td"><c:out
																	value="${ viewAllInfo.account_bank }" />
															<td id="qq" class="free-td"><c:out
																	value="${ viewAllInfo.account_host }" />
															<td id="qq" class="free-td"><c:out
																	value="${ viewAllInfo.address }" />
															<td id="qq" class="free-td"><button id="delete_log"
																	class="btn_delete" type="button">삭제</button></td>
														</tr>
													</c:forEach>
												</tbody>
				...
				<div class="tab-pane fade" id="emp_job">
					<div class="tab-content">
						<div class="ehr_con_wrap">
							<div>
								<h3 class="tab_title">직위변경</h3>
								<!--탭 전체 펼치기시 타이틀 나옴-->
								<div class="ehr_jop viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/joblevel"
										method="post">
										...
										<table class="type_list_box">
                                          ...
                                          <input class="txt w_max" type="text" name="spot_no" value=""/>">
															...
															<td class="start"><input class="txt w_max"
																type="date" name="spot_date" value=""></td>
															<td class="end"><input class="txt w_max" type="text"
																name="spot_code" value=""></td>
															<td class="position"><input class="txt w_max"
																type="text" name="member_no" value=""></td>

														</c:when>
														<c:otherwise>
															<!-- c:forEach 시작 부분 -->
															<c:forEach var="modispotDto"
																items="${ requestScope.modispotDto }">
																<%--  <td class="no">
                                             <input class="txt w_max" type="text" name="spot_no" value="<c:out value="${ modispotDto.spot_no }"/>">
                                             </td> --%>
																<td class="start"><input class="txt w_max"
																	type="date" name="spot_date"
																	value="<c:out value="${ modispotDto.spot_date }"/>">
																</td>
																<td class="end"><input class="txt w_max"
																	type="text" name="spot_code"
																	value="<c:out value="${ modispotDto.spot_code }"/>">
																</td>
																<td class="position"><input class="txt w_max"
																	type="text" name="member_no"
																	value="<c:out value="${ modispotDto.member_no }"/>">
																</td>
															</c:forEach>
															<!-- c:forEach 끝 부분 -->
														</c:otherwise>
							...
							<div class="page_action_wrap" style="display: block;"></div>
							<section class="aside_wrapper article_reply" id="hrcardActivity">
								<div>
									<div class="reply_wrap">
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<tbody id="viewModispotDto">
													...
													<c:forEach var="viewModispotDto"
														items="${requestScope.viewModispotDto }">
														<tr>
															<td class="free-td"><c:out
																	value="${ viewModispotDto.member_no }" />
															<td class="free-td"><c:out
																	value="${ viewModispotDto.spot_code }" />
															<td class="free-td"><c:out
																	value="${ viewModispotDto.spot_date }" />
										...
										<div class="aside_wrapper_body">
											...
											<div id="moreLog" class="bottom_action"
												style="display: none;">
												<a class="btn_list_reload"><span class="ic"></span><span
													class="txt">더보기</span></a>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="tab-pane fade" id="emp_part">
					<div class="tab-content">
						<div class="ehr_con_wrap">
							<div>
								<h3 class="tab_title">부서</h3>
								<!--탭 전체 펼치기시 타이틀 나옴-->
								<div class="ehr_jop viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/part"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
										<table class="type_list_box">
                                          ...
                                          <input class="txt w_max" type="text" name="modifyDeptNo" value=""/>">
															...
															<td class="start"><input class="txt w_max"
																type="date" name="modifydate" value="" />"></td>
															<td class="end"><input class="txt w_max" type="text"
																name="deptCode" value="" />"></td>
															<td class="position"><input class="txt w_max"
																type="text" name="memberNo" value="" />"></td>

														</c:when>
														<c:otherwise>
															<!-- c:forEach 시작 부분 -->
															<c:forEach var="modidept"
																items="${ requestScope.modidept }">
																<%-- <td class="no">
                                             <input class="txt w_max" type="text" name="modifyDeptNo" value="<c:out value="${ modidept.modifyDeptNo }"/>">
                                                   
                                             </td> --%>
																<td class="start"><input class="txt w_max"
																	type="date" name="modifydate"
																	value="<c:out value="${ modidept.modifydate }"/>">
																</td>
																<td class="end"><input class="txt w_max"
																	type="text" name="deptCode"
																	value="<c:out value="${ modidept.deptCode }"/>">
																</td>
																<td class="position"><input class="txt w_max"
																	type="text" name="memberNo"
																	value="<c:out value="${ modidept.memberNo }"/>">
																</td>
															</c:forEach>
															<!-- c:forEach 끝 부분 -->
														</c:otherwise>
									...
									<div class="reply_wrap">
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<c:forEach var="viewMemberDept"
													items="${requestScope.viewMemberDept }">
													<tr>
														<td class="free-td"><c:out
																value="${ viewMemberDept.memberNo }" />
														<td class="free-td"><c:out
																value="${ viewMemberDept.deptCode }" />
														<td class="free-td"><c:out
																value="${ viewMemberDept.modifydate }" />
														<td><button id="delete_log" class="btn_delete"
						...
						<div class="ehr_con_wrap">
							<div>
								...
								<div class="ehr_career viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/career"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
										<table class="type_list_box">
                                          ...
                                          <input class="txt w_max" type="text" name="no" value=""/>">
															...
															<td class="start"><input class="txt w_max"
																type="date" name="start" value="" /></td>
															<td class="end"><input class="txt w_max" type="date"
																name="end" value="" /></td>
															<td class="position"><input class="txt w_max"
																type="text" name="position" value="" /></td>
															<td class="member_no"><input class="txt w_max"
																type="text" name="member_no" value="" /></td>
														</c:when>
														<c:otherwise>
															<!-- c:forEach 시작 부분 -->
															<c:forEach var="careerDto"
																items="${ requestScope.careerDto }">
																<%--   <td class="no">
                                             <input class="txt w_max" type="text" name="no" value="<c:out value="${ careerDto.no }"/>">
																...
																<td class="start"><input class="txt w_max"
																	...
																	value="<c:out value="${ careerDto.start }"/>">
																</td>
																<td class="end"><input class="txt w_max"
																	type="date" name="end"
																	value="<c:out value="${ careerDto.end }"/>"></td>
																<td class="position"><input class="txt w_max"
																	type="text" name="position"
																	value="<c:out value="${ careerDto.position }"/>">
																</td>
																<td class="position"><input class="txt w_max"
																	type="text" name="member_no"
																	value="<c:out value="${ careerDto.member_no }"/>">
																</td>
															</c:forEach>
															<!-- c:forEach 끝 부분 -->
														</c:otherwise>
									...
									<div class="reply_wrap">
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<c:forEach var="viewCareerDto"
													items="${requestScope.viewCareerDto }">
													<tr>
														<td class="free-td"><c:out
																value="${ viewCareerDto.member_no }" />
														<td class="free-td"><c:out
																value="${ viewCareerDto.position }" />
														<td class="free-td"><c:out
																value="${ viewCareerDto.start }" />
														<td class="free-td"><c:out
																value="${ viewCareerDto.end }" />
														<td><button id="delete_log" class="btn_delete"
																type="button">삭제</button></td>
													</tr>
												</c:forEach>
						...
						<div class="ehr_con_wrap">
							<div>
								...
								<div class="ehr_reward viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/bonus"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
										<table class="type_list_box">
                                          ...
                                          <input class="txt w_max" type="text" name="no" value=""/>">
															...
															<td class="reason"><input class="txt w_max"
																type="text" name="reason" value=""></td>
															<td class="date"><input class="txt w_max"
																type="date" name="date" value=""></td>
															<td class="type"><input class="txt w_max"
																type="text" name="type" value=""></td>
															<td class="member_no"><input class="txt w_max"
																type="text" name="member_no" value=""></td>
															<td class="approve_code"><input class="txt w_max"
																type="text" name="approve_code" value=""></td>
														</c:when>
														<c:otherwise>
															<!-- c:forEach 시작 부분 -->
															<c:forEach var="bonusDto"
																items="${ requestScope.bonusDto }">
																<%-- <td class="no">
                                             <input class="txt w_max" type="text" name="no" value="<c:out value="${ bonusDto.no }"/>">
                                                   
                                             </td> --%>
																<td class="reason3"><input class="txt w_max"
																	type="text" name="reason"
																	value="<c:out value="${ bonusDto.reason }"/>">
																</td>
																<td class="date"><input class="txt w_max"
																	type="date" name="date"
																	value="<c:out value="${ bonusDto.date }"/>"></td>
																<td class="type"><input class="txt w_max"
																	type="text" name="type"
																	value="<c:out value="${ bonusDto.type }"/>"></td>
																<td class="member_no"><input class="txt w_max"
																	type="text" name="member_no"
																	value="<c:out value="${ bonusDto.member_no }"/>" /></td>
																<td class="approve_code"><input class="txt w_max"
																	type="text" name="approve_code"
																	value="<c:out value="${ bonusDto.approve_code }"/>">
																</td>
															</c:forEach>
															<!-- c:forEach 끝 부분 -->
														</c:otherwise>
									...
									<div class="reply_wrap">
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<c:forEach var="viewBonusDto"
													items="${ requestScope.viewBonusDto }">
													<tr>
														<td class="free-td"><c:out
																value="${ viewBonusDto.member_no }" />
														<td class="free-td"><c:out
																value="${ viewBonusDto.date }" />
														<td class="free-td"><c:out
																value="${ viewBonusDto.type }" />
														<td class="free-td"><c:out
																value="${ viewBonusDto.reason }" />
														<td class="free-td"><c:out
																value="${ viewBonusDto.approve_code }" />
														<td><button id="delete_log" class="btn_delete"
																type="button">삭제</button></td>
													</tr>
												</c:forEach>
						...
						<div class="ehr_con_wrap">
							<div>
								...
								<div class="ehr_qualification viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/certificate"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
										<table class="type_list_box">
                                          ...
                                          <input class="txt w_max" type="text" name="no" value=""/>
															...
															<td class="start_date"><input class="txt w_max"
																type="date" name="start_date" value=""></td>
															<td class="end_date"><input class="txt w_max"
																type="date" name="end_date" value=""></td>
															<td class="member_no"><input class="txt w_max"
																type="text" name="member_no" value=""></td>
															<td class="member_no"><input class="txt w_max"
																type="text" name="certificate_code" value="">
														</c:when>
														<c:otherwise>
															<!-- c:forEach 시작 부분 -->
															<c:forEach var="certificateInsert"
																items="${ requestScope.certificateInsert }">
																<%--  <td class="no">
                                             <input class="txt w_max" type="text" name="no" value="<c:out value="${ certificateInsert.no }"/>">
																...
																<td class="start_date"><input class="txt w_max"
																	...
																	value="<c:out value="${ certificateInsert.start_date }"/>">
																</td>
																<td class="end_date"><input class="txt w_max"
																	type="date" name="end_date"
																	value="<c:out value="${ certificateInsert.end_date }"/>">
																</td>
																<td class="member_no"><input class="txt w_max"
																	type="text" name="member_no"
																	value="<c:out value="${ certificateInsert.member_no }"/>">
																</td>
																<td class="certificate_code"><input
																	class="txt w_max" type="text" name="certificate_code"
																	value="<c:out value="${ certificateInsert.certificate_code }"/>">
																</td>
									...
									<div class="reply_wrap">
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<c:forEach var="viewCertificateInsert"
													items="${ requestScope.viewCertificateInsert }">
													<tr>
														<td class="free-td"><c:out
																value="${ viewCertificateInsert.member_no }" />
														<td class="free-td"><c:out
																value="${ viewCertificateInsert.certificate_code }" />
														<td class="free-td"><c:out
																value="${ viewCertificateInsert.start_date }" />
														<td class="free-td"><c:out
																value="${ viewCertificateInsert.end_date }" />
														<td><button id="delete_log" class="btn_delete"
																type="button">삭제</button></td>
													</tr>
												</c:forEach>
						...
						<div class="ehr_con_wrap">
							<div>
								...
								<div class="ehr_military viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/army"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
										<table class="type_list_box">
											<tbody>
												...
												<tr>
													<c:choose>
														<c:when test="${ empty requestScope.armySelect }">
															...
															<td class="member_no"><input class="txt w_max"
																type="text" name="member_no" value="" /></td>
															<td class="army_no"><input class="txt w_max"
																type="text" name="army_no" value=""></td>
															<td class="branch"><input class="txt w_max"
																type="text" name="branch" value=""></td>
															<td class="army_class"><input class="txt w_max"
																type="text" name="army_class" value=""></td>
															<td class="service_num"><input class="txt w_max"
																type="text" name="service_num" value=""></td>
															<td class="discharge"><input class="txt w_max"
																type="text" name="discharge" value=""></td>
															<td class="start"><input class="txt w_max"
																type="date" name="start" value=""></td>
															<td class="date"><input class="txt w_max"
																type="date" name="date" value=""></td>
														...
														<c:otherwise>
															<!-- c:forEach 시작 부분 -->
															<c:forEach var="armySelect"
																items="${ requestScope.armySelect }">
																<%--   <td class="member_no">
                                             <input class="txt w_max" type="text" name="member_no" value="${ sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.memberno }">
																...
																<td class="army_no"><input class="txt w_max"
																	type="text" name="army_no"
																	value="<c:out value="${ armySelect.army_no }"/>">
																</td>
																<td class="branch"><input class="txt w_max"
																	type="text" name="branch"
																	value="<c:out value="${ armySelect.branch }"/>">
																</td>
																<td class="army_class"><input class="txt w_max"
																	type="text" name="army_class"
																	value="<c:out value="${ armySelect.army_class }"/>">
																</td>
																<td class="service_num"><input class="txt w_max"
																	type="text" name="service_num"
																	value="<c:out value="${ armySelect.service_num }"/>">
																</td>
																<td class="discharge"><input class="txt w_max"
																	type="text" name="discharge"
																	value="<c:out value="${ armySelect.discharge }"/>">
																</td>
																<td class="start"><input class="txt w_max"
																	type="date" name="start"
																	value="<c:out value="${ armySelect.start }"/>">
																</td>
																<td class="end"><input class="txt w_max"
																	type="date" name="date"
																	value="<c:out value="${ armySelect.end }"/>"></td>
																<td class="reason"><input class="txt w_max"
																	type="text" name="reason"
																	value="<c:out value="${ armySelect.reason }"/>">
																</td>
															</c:forEach>
															<!-- c:forEach 끝 부분 -->
														</c:otherwise>
									...
									<div class="reply_wrap">
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<c:forEach var="viewArmySelect"
													items="${requestScope.viewArmySelect }">
													<tr>
														<td class="free-td"><c:out
																value="${ viewArmySelect.member_no }" />
														<td class="free-td"><c:out
																value="${ viewArmySelect.branch }" />
														<td class="free-td"><c:out
																value="${ viewArmySelect.army_class }" />
														<td class="free-td"><c:out
																value="${ viewArmySelect.service_num }" />
														<td class="free-td"><c:out
																value="${ viewArmySelect.discharge }" />
														<td class="free-td"><c:out
																value="${ viewArmySelect.start }" />
														<td class="free-td"><c:out
																value="${ viewArmySelect.end }" />
														<td class="free-td"><c:out
																value="${ viewArmySelect.reason }" />
														<td><button id="delete_log" class="btn_delete"
																type="button">삭제</button></td>
													</tr>
												</c:forEach>
						...
						<div class="ehr_con_wrap">
							<div>
								...
								<div class="ehr_academy viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/finalAcademic"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
										<table class="type_list_box">
                                          ...
                                          <input class="txt w_max" type="text" name="ability_no" value=""/>
														...
														<td class="name"><input class="txt w_max" type="text"
															name="name" value=""></td>
														<td class="subject"><input class="txt w_max"
															type="text" name="subject" value=""></td>
														<td class="date"><input class="txt w_max" type="date"
															name="date" value=""></td>
														<td class="graduate_status"><input class="txt w_max"
															type="text" name="graduate_status" value=""></td>
														<td class="graduate_name"><input class="txt w_max"
															type="text" name="graduate_name" value=""></td>
														<td class="member_no"><input class="txt w_max"
															type="text" name="member_no"
															value="${ sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.memberno }">
														</td>
														<td class="code"><input class="txt w_max" type="text"
															name="code" value=""></td>

													</c:when>
													<c:otherwise>
														<!-- c:forEach 시작 부분 -->
														<c:forEach var="academic"
															items="${ requestScope.academic }">
															<%--  <td class="ability_no">
                                             <input class="txt w_max" type="text" name="ability_no" value="<c:out value="${ academic.ability_no }"/>">
                                             </td> --%>
															<td class="name"><input class="txt w_max"
																type="text" name="name"
																value="<c:out value="${ academic.name }"/>"></td>
															<td class="subject"><input class="txt w_max"
																type="text" name="subject"
																value="<c:out value="${ academic.subject }"/>">
															</td>
															<td class="date"><input class="txt w_max"
																type="date" name="date"
																value="<c:out value="${ academic.date }"/>"></td>
															<td class="graduate_status"><input class="txt w_max"
																type="text" name="graduate_status"
																value="<c:out value="${ academic.graduate_status }"/>">
															</td>
															<td class="graduate_name"><input class="txt w_max"
																type="text" name="graduate_name"
																value="<c:out value="${ academic.graduate_name }"/>">
															</td>
															<td class="member_no"><input class="txt w_max"
																type="text" name="member_no"
																value="${ sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.memberno }">
															</td>
															<td class="code"><input class="txt w_max"
																type="text" name="code"
																value="<c:out value="${ academic.code }"/>"></td>
									...
									<div class="reply_wrap">
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<c:forEach var="viewAcademic"
													items="${requestScope.viewAcademic }">
													<tr>
														<td class="free-td"><c:out
																value="${ viewAcademic.member_no }" />
														<td class="free-td"><c:out
																value="${ viewAcademic.name }" />
														<td class="free-td"><c:out
																value="${ viewAcademic.subject }" />
														<td class="free-td"><c:out
																value="${ viewAcademic.date }" />
														<td class="free-td"><c:out
																value="${ viewAcademic.graduate_status }" />
														<td class="free-td"><c:out
																value="${ viewAcademic.graduate_name }" />
														<td class="free-td"><c:out
																value="${ viewAcademic.code }" />
														<td><button id="delete_log" class="btn_delete"
																type="button">삭제</button></td>
													</tr>
												</c:forEach>
				...
				<div class="tab-pane fade" id="emp_family">
					<div class="card">
						<div class="ehr_con_wrap">
							<div>
								<h3 class="tab_title">가족사항</h3>
								<div class="ehr_family viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/family"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
										<table class="type_list_box">
                                          ...
                                          <input class="txt w_max" type="text" name="info_no" value=""/>
															...
															<td class="relation"><input class="txt w_max"
																type="text" name="relation" value=""></td>
															<td class="gender">
																<!-- <input class="txt w_max" type="text" name="gender" value=""> -->
																<span class="wrap_select"> <select
																	class="wfix_small" name="gender" value="">
															...
															<td class="birthday"><input class="txt w_max"
																type="date" name="birthday" value=""></td>
															<td class="study"><input class="txt w_max"
																type="text" name="study" value=""></td>
															<td class="job"><input class="txt w_max" type="text"
																name="job" value=""></td>
															<td class="no"><input class="txt w_max" type="text"
																name="no" value=""></td>

														</c:when>
														<c:otherwise>
															<!-- c:forEach 시작 부분 -->
															<c:forEach var="familySelect"
																items="${ requestScope.familySelect }">
																<%-- <td class="info_no">
                                             <input class="txt w_max" type="text" name="info_no" value="<c:out value="${ familySelect.info_no }"/>">
                                             </td> --%>
																<td class="name"><input class="txt w_max"
																	type="text" name="name"
																	value="<c:out value="${ familySelect.name }"/>">
																</td>
																<td class="relation"><input class="txt w_max"
																	type="text" name="relation"
																	value="<c:out value="${ familySelect.relation }"/>">
																</td>
																<td class="gender">
																	<%-- <input class="txt w_max" type="text" name="gender" value="<c:out value="${ familySelect.gender }"/>">
                                              --%> <span
																	class="wrap_select"> <select class="wfix_small"
																		name="gender"
																		value="<c:out value="${ familySelect.gender }"/>">
																			<option value="">선택하세요</option>
																			<option value="남">남자</option>
																			<option value="녀">여자</option>
																	</select>
																...
																<td class="birthday"><input class="txt w_max"
																	...
																	value="<c:out value="${ familySelect.birthday }"/>">
																</td>
																<td class="study"><input class="txt w_max"
																	type="text" name="study"
																	value="<c:out value="${ familySelect.study }"/>">
																</td>
																<td class="job"><input class="txt w_max"
																	type="text" name="job"
																	value="<c:out value="${ familySelect.job }"/>">
																</td>
																<td class="no"><input class="txt w_max" type="text"
																	name="no" value="<c:out value="${ familySelect.no }"/>">
																</td>
								...
								<div class="reply_wrap">
									<header class="single_title">
										<table class="table table-striped custom-table datatable">
											...
											<c:forEach var="viewFamilySelect"
												items="${requestScope.viewFamilySelect }">
												<tr>
													<td class="free-td"><c:out
															value="${ viewFamilySelect.no }" />
													<td class="free-td"><c:out
															value="${ viewFamilySelect.name }" />
													<td class="free-td"><c:out
															value="${ viewFamilySelect.relation }" />
													<td class="free-td"><c:out
															value="${ viewFamilySelect.gender }" />
													<td class="free-td"><c:out
															value="${ viewFamilySelect.birthday }" />
													<td class="free-td"><c:out
															value="${ viewFamilySelect.study }" />
													<td class="free-td"><c:out
															value="${ viewFamilySelect.job }" />
													<td><button id="delete_log" class="btn_delete"
															type="button">삭제</button></td>
												</tr>
											</c:forEach>
									...
									<div class="aside_wrapper_body">
										...
										<div id="moreLog" class="bottom_action" style="display: none;">
											<a class="btn_list_reload"><span class="ic"></span><span
												class="txt">더보기</span></a>
										</div>
									</div>
				...
				<div class="tab-pane fade" id="emp_license">
					<div class="card">
						<div class="ehr_con_wrap">
							<div>
								<h3 class="tab_title">면허</h3>
								<!--탭 전체 펼치기시 타이틀 나옴-->
								<div class="ehr_qualification viewForm">
									<form
										action="${ pageContext.servletContext.contextPath }/profile/license"
										method="post">
										<input type="hidden" name="memberno"
											value="${requestScope.memberno}">
										<table class="type_list_box">
                                          ...
                                          <input class="txt w_max" type="text" name="no" value=""/>
													...
													<c:otherwise>
														<!-- c:forEach 시작 부분 -->
														<c:forEach var="LicenseDto"
															items="${ requestScope.LicenseDto }">
															<%--  <td class="no">
                                             <input class="txt w_max" type="text" name="no" value="<c:out value="${ LicenseDto.no }"/>">
                                             </td> --%>
															<td class="code"><input class="txt w_max"
																type="text" name="code"
																value="<c:out value="${ LicenseDto.code }"/>"></td>
															<td class="date"><input class="txt w_max"
																type="date" name="date"
																value="<c:out value="${ LicenseDto.date }"/>"></td>
															<td class="member_no"><input class="txt w_max"
																type="text" name="member_no"
																value="${ sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.memberno }"" >
															</td>
									...
									<div class="reply_wrap">
										<header class="single_title">
											<table class="table table-striped custom-table datatable">
												...
												<c:forEach var="viewLicenseDto"
													items="${requestScope.viewLicenseDto }">
													<tr>
														<td class="free-td"><c:out
																value="${ viewLicenseDto.member_no }" />
														<td class="free-td"><c:out
																value="${ viewLicenseDto.code }" />
														<td class="free-td"><c:out
																value="${ viewLicenseDto.date }" />
														<td><button id="delete_log" class="btn_delete"
																type="button">삭제</button></td>
													</tr>
												</c:forEach>
		...
		<div id="profile_info" class="modal custom-modal fade" role="dialog">
			<div class="modal-dialog modal-dialog-centered modal-lg"
				role="document">
				<form id="memberTest" name="member"
					action="http://127.0.0.1:8001/billbo/profile/mainProfile2"
					method="post">
						...
						<div class="modal-content sub-modal">
							...
							<div class="modal-body">
									...
									<div class="col-md-12">
										<c:forEach var="detailMem" items="${ requestScope.detailMem }">
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>연락처 변경</label> <input class="txt w_max" type="text"
															name="phone" value="<c:out value="${detailMem.phone}"/>">
														<!-- <div class="text"></div> -->
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>이메일 변경</label> <input type="text"
															class="form-control" name="email"
															value="<c:out value="${detailMem.email}"/>">
													</div>
												</div>
												<%-- <div class="col-md-6">
													<div class="form-group">
								...
								<div class="submit-section">
									<button class="btn btn-primary submit-btn" data-role="button"
										type="button" onclick="submit1(this.form)">Submit</button>
								</div>
  ...
  /*   	var phone = $("select[phone='phone']").val();
	...
	<script
		src="/billbo/resources/hrtemp/js/bootstrap-datetimepicker.min.js"></script>

	<!-- Tagsinput JS -->
	<script
		src="/billbo/resources/hrtemp/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js"></script>
